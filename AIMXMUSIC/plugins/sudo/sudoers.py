...
from AIMXMUSIC.misc import SUDOERS
from AIMXMUSIC.utils.database import add_sudo, remove_sudo
from AIMXMUSIC.utils.decorators.language import language
from AIMXMUSIC.utils.extraction import extract_user
from AIMXMUSIC.utils.inline import close_markup
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("Bsᴅᴋ Aᴜᴋᴀᴛ Mᴇ Rᴇʜ Lᴇ... 🖕😎😂", show_alert=True)
    else:
